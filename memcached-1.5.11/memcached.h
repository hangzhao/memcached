...
#define NUMBER_OF_NAME_SPACES 99
...
//每一个命名空间的状态统计
extern struct stats namespace_stats[NUMBER_OF_NAME_SPACES];
extern struct stats_state namespace_stats_state[NUMBER_OF_NAME_SPACES];
...
typedef struct {
    ...
    struct thread_stats namespace_stats[NUMBER_OF_NAME_SPACES];
